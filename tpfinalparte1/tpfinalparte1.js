...
//URL YOUTUBE: https://www.youtube.com/watch?v=-3xGh6jOmpc
...
function preload() {
  //Precarga de los archivos que vamos a necesitar luego, imágenes y sonido
...
function setup() { createCanvas(640, 480);
  //Valor de cada elemento i del arreglo pantallas.
...
function draw() {
  ...
  background(0); //Limpia el background
  if (estado === 16) {
  ...
  // Dibuja la pantalla correspondiente según el elemento del arreglo y el parámetro correspondiente de la funcion "estructura"
...
function mousePressed() {
  //Uso lógica switch para agrupar condicionales según el estado
  switch(estado) {
  case 0:
  ...
  // Reproducir el audio si el estado es mayor igual a 1 y no se está reproduciendo
